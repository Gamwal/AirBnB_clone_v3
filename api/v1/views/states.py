#!/usr/bin/python3
"""
States view module to handle RESTful API actions for State objects.
"""
...
def get_state(state_id):
    ...
    Returns:
        A JSON response with the State object.
    """
...
def create_state():
    ...
    Returns:
        The new State object with status code 201.
    """
...
def update_state(state_id):
    ...
    Returns:
        The updated State object with status code 200.
    """
    state = storage.get(State, state_id)
    if state is None:
        abort(404)
